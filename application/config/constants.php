...
//RUTAS PUBLICAS
defined('RUTA_PROYECTO')  OR define('RUTA_PROYECTO' , '/crud_angular');
...
defined('RUTA_CSS')       OR define('RUTA_CSS'      , 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).RUTA_PROYECTO.'/public/css/');
